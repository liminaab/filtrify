...
var UAT3TestDataFormatted [][]string = [][]string{
	{"Instrument name", "Instrument Type", "Quantity", "Market Value (Base)", "Exposure %", "Maturity Date", "EU Sanction listed", "Active From"},
	{"a", "Equity", "1.00", "2000000.00", "8%", "", "true", "2020-01-01 12:00:00"},
	{"b", "Equity", "2.00", "6000000.00", "25%", "", "false", "2020-03-01 12:00:00"},
	{"e", "Bill", "3.00", "8750000.00", "30%", "2021-12-31", "false", "2020-11-22 12:00:00"},
	{"", "Index Future", "-10.00", "-495000.00", "17%", "2021-12-16", "false", "2021-04-06 12:00:00"},
	{"d", "Cash Account2", "2.60", "5000000.0", "20%", "", "", "2020-01-01 12:00:00"},
	{"c", "Cash Account", "4.00", "5000000.0", "20%", "", "", "2020-01-01 12:00:00"},
}
